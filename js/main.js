...
const getAPIData = async (city, zipcode=null) => {
    let response = await fetch(`https://api.openweathermap.org/data/2.5/weather?zipcode=${zipcode},us&q=${city}&appid=900eee3f4e6d3e40090ade1876b9fcc3&units=imperial`);
